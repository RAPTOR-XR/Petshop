						...
						<div class="col-md-5 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>66, Mohakhali, Dhaka</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+880-1643-412-632</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>petshop@something.com</a></li>
								</ul>
							</div>
						</div>
