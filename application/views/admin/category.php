            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-tag"></i> Categories
                                        ...
                                        <tbody align="center">                                
                                            <?php foreach($cat as $data){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="button" class="btn btn-danger btn-sm" name="del" id="del" value="delete" onclick="Deletedata('<?php echo $data['cat_id']?>')">
                                                    </td>
                                                </tr>
                                            <?php }?>
                                        </tbody>
...
<script>
    $("#save").on('click',function(){
        var name = $("#name").val();
        if (name!=""){
            $.post("<?php echo base_url();?>Admin_cont/addcat",{
                    name:name,
            },function(data){
    ...
    function Deletedata(cat_id){
        $.post("<?php echo base_url()?>Admin_cont/deletecat",{
            cat_id:cat_id
        },function(data){
            window.location.href = "<?php echo base_url()?>Admin/Category";
        });
